...
function Step1SetUP({onStart}) {
    ...
    try {
        ...
        console.log("START INTERVIEW ERROR:", error.response?.data || error);
        setLoading(false);
    }
};
    return (
    ...
    justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4'>
        ...
        <div className='w-full max-w-6xl bg-white rounded-3xl shadow-
        2xl grid md:grid-cols-2 overflow-hidden'>
            ...
            to-green-300 p-12 flex flex-col justify-center'>
                ...
                <div className='space-y-6'>
                    ...
                    <select value={mode}
                        ...
                        {!analysisDone && (
                            ...
                            p-8 text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transition'>
